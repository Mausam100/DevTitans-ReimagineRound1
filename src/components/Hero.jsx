      ...
      <main className=" bg-white w-full h-fit flex flex-col md:flex-row p-5 md:p-10 mt-8 justify-evenly gap-10 md:gap-0">
        ...
        >
          <div id="button" className="flex flex-col gap-5">
            ...
            <p className="text-2xl sm:text-2xl md:text-2vw leading-none text-nowrap ">
            ...
            <button className="group flex flex-row gap-1 justify-evenly items-center border-[1px] border-neutral-700 rounded-3xl px-[0.75vw] py-[0.5vw] transition-color duration-300 bg-white text-black hover:bg-black hover:text-white">
              ...
              <span className="dg-bold text-2xl md:text-xl text-nowrap uppercase -translate-y-0.5 group-hover:-translate-x-1 transition-transform duration-300">
                Shop Now
              </span>
