...
const Hero = () => {
  return (
    <main className=" px-4 text-[#272727] sm:flex dg-normal">
        ...
        <div className=" md:mt-10 ">
          <div className="">
            ...
            <div className="-mt-5">
              ...
              <div className="flex gap-2 mt-2 sm:ml-4 md:ml-16">
                <div className=" w-1/3">
            ...
            <h2 className=" text-4xl mt-3 sm:text-3xl sm:">
      ...
      {/* click div */}
      <div className="right-div sm:w-1/2 sm:pt-10 sm:items-center md:md:w-1/3 md:ml-40 ">
