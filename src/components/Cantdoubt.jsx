          ...
          <div className="w-full flex gap-5 flex-col">
            <div className="flex flex-col md:flex-row gap-5">
              <div className="1st w-full h-24 flex flex-row items-center justify-start gap-5">
                ...
                <div className="w-2/3 h-full flex flex-col items-start justify-center gap-1">
                  <h3 className="text-2xl md:text-xl md:leading-none lg:text-2xl">Total Transparency</h3>
            ...
            <div className="flex flex-col md:flex-row gap-5">
              ...
              <div className="4th w-full h-24 flex flex-row items-center justify-start gap-5">
                ...
                <div className="w-2/3 h-full flex flex-col items-start justify-center gap-1">
                  <h3 className="text-2xl md:text-xl md:leading-none lg:text-2xl">Best Ingredients</h3>
                  <p className="text-md leading-none">
